  ...
  return (
    <footer className="footer">
      <div className="footer-top text-center">
        <h2 className="footer-heading">Ready to start agreeing contracts faster?</h2>
        <p className="footer-subheading">
          Discover the power of turning data into dynamic action with low-code application building from VroxHub.
        </p>
        <div className="footer-buttons">
          <button className="btn btn-outline-light">Try for free</button>
          <button className="btn btn-outline-light">Book a demo</button>
        </div>
      </div>
